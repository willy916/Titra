...
const isStep1Valid = computed(() => formData.value.federationName && formData.value.registrationNumber && formData.value.presidentName && formData.value.region && formData.value.location)
