  ...
  <div class="min-h-screen bg-background pb-20">
    <div class="sticky top-0 z-10 bg-white border-b">
      <div class="p-4">
        ...
        <h1 class="text-xl font-bold">Commandes clients</h1>
        <p class="text-xs text-muted-foreground mt-1">Gérez les commandes de vos clients</p>
      </div>
    ...
    <div class="p-4">
      ...
      <div v-else class="space-y-4">
        <Card
          ...
          @click="emit('navigate', 'order-detail', { order, fromScreen: 'customer-orders' })"
        >
          ...
          <div class="flex items-center justify-between pt-3 border-t">
            <div class="text-sm">
              <p class="text-[10px] uppercase tracking-wider text-muted-foreground mb-0.5">Client</p>
